    ...
    employees: [
      {
        ...
        knowledgeIds: [],
        tools: [
          { id: 'web_search', name: 'Web Search', source: 'builtin', enabled: true, requiresApproval: false },
          { id: 'web_browse', name: 'Web Browse', source: 'builtin', enabled: true, requiresApproval: false },
          { id: 'read_file', name: 'Read Files', source: 'builtin', enabled: true, requiresApproval: false },
        ],
        provider: 'openai',
        model: 'gpt-4o',
      ...
      },
      {
        ...
        tools: [
          { id: 'read_file', name: 'Read Files', source: 'builtin', enabled: true, requiresApproval: false },
          { id: 'write_file', name: 'Write Files', source: 'builtin', enabled: true, requiresApproval: true },
          { id: 'execute_code', name: 'Execute Code', source: 'builtin', enabled: true, requiresApproval: true },
...
export function installMockApi() {
  ...
  const mockApi = {
    ...
    native: {
      list: async () => [],
      toggle: async (_id: string, _enabled: boolean) => ({ success: true, tools: [] })
    },
    mcp: {
