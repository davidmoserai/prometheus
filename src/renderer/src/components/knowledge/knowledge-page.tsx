          ...
          <div className="grid grid-cols-2" style={{ gap: '28px' }}>
            {filtered.map((doc, i) => (
              ...
              >
                ...
                <p className="relative text-[13px] text-text-tertiary line-clamp-3 leading-relaxed" style={{ marginBottom: '20px' }}>
                ...
                <p className="relative text-[12px] text-text-tertiary" style={{ marginTop: '20px' }}>
